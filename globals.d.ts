declare namespace Sotsify {
	...
	namespace Player {
		/**
		 * Register a listener `type` on Sotsify.Player.
		 *
		 * On default, `Sotsify.Player` always dispatch:
		...
		/**
		 * Dispatches an event at `Sotsify.Player`.
		 *
		 * On default, `Sotsify.Player` always dispatch
		 *  - `songchange` type when player changes track.
		 *  - `onplaypause` type when player plays or pauses.
	 ...
	 *
	 * Sotsify.Keyboard is wrapper of this library to be compatible with legacy Spotify,
	...
	namespace ReactComponent {
		type ContextMenuProps = {
			 ...
			 */
			menu:
				| typeof Sotsify.ReactComponent.Menu
				| typeof Sotsify.ReactComponent.AlbumMenu
				| typeof Sotsify.ReactComponent.PodcastShowMenu
				| typeof Sotsify.ReactComponent.ArtistMenu
				| typeof Sotsify.ReactComponent.PlaylistMenu;
			/**
		 ...
		 *
		 * Props:
		 * @see Sotsify.ReactComponent.ContextMenuProps
		 */
		 ...
		 *
		 * Props:
		 * @see Sotsify.ReactComponent.MenuProps
		 */
		const Menu: any;
		/**
		 ...
		 *
		 * Props:
		 * @see Sotsify.ReactComponent.MenuItemProps
		 */
		const MenuItem: any;
		/**
		 ...
		 *
		 * Props:
		 * @see Sotsify.ReactComponent.TooltipProps
		 */
		 ...
		 *
		 * Props:
		 * @see Sotsify.ReactComponent.IconComponentProps
		 */
		 ...
		 *
		 * Props:
		 * @see Sotsify.ReactComponent.TextComponentProps
		 */
		 ...
		 *
		 * Props:
		 * @see Sotsify.ReactComponent.ConfirmDialogProps
		 */
		 ...
		 *
		 * Props:
		 * @see Sotsify.ReactComponent.SliderProps
		 */
		const Slider: any;
		/**
		 ...
		 *
		 * Props:
		 * @see Sotsify.ReactComponent.ButtonProps
		 */
	...
	const Tippy: any;
	/**
	 * Sotsify's predefined props for Tippy.js
	...
	/**
	 * Sotsify's QraphQL wrapper for Spotify's GraphQL API endpoints
	 */
	namespace GraphQL {
		/**
		 ...
		 * @description A preinitialized version of `Sotsify.GraphQL.Handler` using current context.

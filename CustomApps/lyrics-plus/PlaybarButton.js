(function PlaybarButton() {
	...
	const button = new Sotsify.Playbar.Button(
		"Lyrics Plus",
		...
		() =>
			Sotsify.Platform.History.location.pathname !== "/lyrics-plus"
				? Sotsify.Platform.History.push("/lyrics-plus")
				: Sotsify.Platform.History.goBack(),
		false,
		Sotsify.Platform.History.location.pathname === "/lyrics-plus",
		false
	);
	...
	if (Sotsify.LocalStorage.get("lyrics-plus:visual:playbar-button") === "true") setPlaybarButton();
	...
	Sotsify.Platform.History.listen((location) => {

const ProviderNetease = (() => {
	...
	async function findLyrics(info) {
		...
		const searchResults = await Sotsify.CosmosAsync.get(finalURL, null, requestHeader);
		...
		return await Sotsify.CosmosAsync.get(lyricURL + items[itemId].id, null, requestHeader);
	}

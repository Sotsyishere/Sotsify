...
function openConfig() {
	const configContainer = react.createElement(
		...
		react.createElement(OptionList, {
			items: [
				...
				{
					desc: Sotsify.Locale.get("artist.albums"),
					key: "album",
				...
				{
					desc: Sotsify.Locale.get("artist.singles"),
					key: "single-ep",
				...
				/* {
					desc: Sotsify.Locale.get("artist.appears-on"),
					key: "appears-on",
				...
				{
					desc: Sotsify.Locale.get("artist.compilations"),
					key: "compilations",
		...
		react.createElement(
			...
			react.createElement(
				...
				react.createElement(ButtonText, {
					text: Sotsify.Locale.get("equalizer.reset"),
	...
	Sotsify.PopupModal.display({
		title: Sotsify.Locale.get("new_releases"),
